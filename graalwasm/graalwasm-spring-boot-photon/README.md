...
When enabling `inspect`, you should see debugging session details after the Spring banner and some log output, and before the application has fully started.
